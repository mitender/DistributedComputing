...
static const char* Greeter_method_names[] = {
  ...
  "/helloworld.Greeter/GetFileContent",
  "/helloworld.Greeter/AddFileContent",
};
...
Greeter::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_SayHelloAgain_(Greeter_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetFileContent_(Greeter_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AddFileContent_(Greeter_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Greeter::Stub::GetFileContent(::grpc::ClientContext* context, const ::helloworld::FileName& request, ::helloworld::FileContent* response) {
  return ::grpc::internal::BlockingUnaryCall< ::helloworld::FileName, ::helloworld::FileContent, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetFileContent_, context, request, response);
}

void Greeter::Stub::async::GetFileContent(::grpc::ClientContext* context, const ::helloworld::FileName* request, ::helloworld::FileContent* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::helloworld::FileName, ::helloworld::FileContent, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetFileContent_, context, request, response, std::move(f));
}

void Greeter::Stub::async::GetFileContent(::grpc::ClientContext* context, const ::helloworld::FileName* request, ::helloworld::FileContent* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetFileContent_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::helloworld::FileContent>* Greeter::Stub::PrepareAsyncGetFileContentRaw(::grpc::ClientContext* context, const ::helloworld::FileName& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::helloworld::FileContent, ::helloworld::FileName, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetFileContent_, context, request);
}

::grpc::ClientAsyncResponseReader< ::helloworld::FileContent>* Greeter::Stub::AsyncGetFileContentRaw(::grpc::ClientContext* context, const ::helloworld::FileName& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetFileContentRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status Greeter::Stub::AddFileContent(::grpc::ClientContext* context, const ::helloworld::AddFileRequest& request, ::helloworld::ServerReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::helloworld::AddFileRequest, ::helloworld::ServerReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_AddFileContent_, context, request, response);
}

void Greeter::Stub::async::AddFileContent(::grpc::ClientContext* context, const ::helloworld::AddFileRequest* request, ::helloworld::ServerReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::helloworld::AddFileRequest, ::helloworld::ServerReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_AddFileContent_, context, request, response, std::move(f));
}

void Greeter::Stub::async::AddFileContent(::grpc::ClientContext* context, const ::helloworld::AddFileRequest* request, ::helloworld::ServerReply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_AddFileContent_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::helloworld::ServerReply>* Greeter::Stub::PrepareAsyncAddFileContentRaw(::grpc::ClientContext* context, const ::helloworld::AddFileRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::helloworld::ServerReply, ::helloworld::AddFileRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_AddFileContent_, context, request);
}

::grpc::ClientAsyncResponseReader< ::helloworld::ServerReply>* Greeter::Stub::AsyncAddFileContentRaw(::grpc::ClientContext* context, const ::helloworld::AddFileRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncAddFileContentRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
Greeter::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Greeter::Service, ::helloworld::FileName, ::helloworld::FileContent, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Greeter::Service* service,
             ::grpc::ServerContext* ctx,
             const ::helloworld::FileName* req,
             ::helloworld::FileContent* resp) {
               return service->GetFileContent(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Greeter_method_names[5],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Greeter::Service, ::helloworld::AddFileRequest, ::helloworld::ServerReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Greeter::Service* service,
             ::grpc::ServerContext* ctx,
             const ::helloworld::AddFileRequest* req,
             ::helloworld::ServerReply* resp) {
               return service->AddFileContent(ctx, req, resp);
             }, this)));
}
...
::grpc::Status Greeter::Service::GetFileContent(::grpc::ServerContext* context, const ::helloworld::FileName* request, ::helloworld::FileContent* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status Greeter::Service::AddFileContent(::grpc::ServerContext* context, const ::helloworld::AddFileRequest* request, ::helloworld::ServerReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
